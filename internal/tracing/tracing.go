...
type tracingImpl struct {
	...
	tokenizeTracer        tracing.TokenizeTracer
...
// TokenizeTracer implements the same method as documented on api.Tracing.
func (t *tracingImpl) TokenizeTracer() tracing.TokenizeTracer {
