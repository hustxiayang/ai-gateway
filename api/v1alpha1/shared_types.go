...
type VersionedAPISchema struct {
	...
	//
	// +kubebuilder:validation:Enum=OpenAI;Cohere;AWSBedrock;AzureOpenAI;GCPVertexAI;GCPAnthropic;Anthropic;AWSAnthropic;AWSInvokeOpenAI
...
const (
	...
	// APISchemaAWSInvokeOpenAI is the schema for OpenAI models hosted on AWS Bedrock.
	// Uses the AWS Bedrock InvokeModel API with OpenAI format for requests and responses.
	//
	// https://aws.amazon.com/bedrock/
	APISchemaAWSInvokeOpenAI APISchema = "AWSInvokeOpenAI"
)
