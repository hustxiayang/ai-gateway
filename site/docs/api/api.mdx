...
/><ApiField
  name="OpenAIAWSAnthropic"
  type="enum"
  required="false"
  description="APISchemaOpenAIAWSAnthropic is the schema for Anthropic models hosted on AWS Bedrock<br />Users still use the OpenAI API format for requests and responses., and ai-gateway would translate them into native Anthropic Messages API<br />https://aws.amazon.com/bedrock/<br />"
/>
#### AWSCredentialsFile
