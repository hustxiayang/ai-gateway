...
/><ApiField
  name="AWSInvokeAnthropic"
  type="enum"
  required="false"
  description="APISchemaAWSInvokeAnthropic is the schema for Anthropic models hosted on AWS Bedrock.<br />Users send requests in OpenAI API format, and ai-gateway translates them into native<br />Anthropic Messages API format for AWS Bedrock InvokeModel/InvokeModelWithResponseStream APIs.<br />https://aws.amazon.com/bedrock/<br />https://docs.aws.amazon.com/bedrock/latest/APIReference/API_runtime_InvokeModel.html<br />"
/>
#### AWSCredentialsFile
